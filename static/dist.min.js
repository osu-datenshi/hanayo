...
function _api(e, t, n, i, o, r, a) {
    ...
    var s = "An error occurred while contacting the Datenshi API. Please report this to a Datenshi developer.";
    $.ajax({
        method: r ? "POST" : "GET",
        dataType: "json",
        url: e + t,
...
var keyPlurals = {
    ...
    singlePageSnippets = {
        ...
        "/leaderboard": function() {
            function e() {
                ...
                window.history.replaceState("", document.title, e.pathname + "?mode=" + favouriteMode + "&p=" + page + "&rx=" + rx + ("" != country ? "&country=" + encodeURI(country) : "") + e.hash), api("leaderboard", {
                    ...
                    e.users.forEach(function(e) {
                        n.append($("<tr />").append(
					$("<td />").text("#" + (50 * (page - 1) + ++i)), 
					$("<td />").html("<a href='/u/" + e.id + "' title='View profile'><i class='" + e.country.toLowerCase() + " flag'></i>" + escapeHTML(e.username) + "</a>"), 
					$("<td />").html(t(e.chosen_mode.pp)), 
					$("<td />").text(e.chosen_mode.accuracy.toFixed(2) + "%"), 
					$("<td />").html(addCommas(e.chosen_mode.playcount) + " <i title='" + T("Why, LOVE, of course!") + "'>(lv. " + e.chosen_mode.level.toFixed(0) + ")</i>"))
				)
            ...
            function t(e, t) {
                return 0 === t ? "<b>" + addCommas(t) + "</b>" : "<b>" + addCommas(e) + "pp</b>"
            }
        ...
        "/beatmaps/rank_request": function() {
            ...
            var t = /^https?:\/\/osu.ppy.sh\/(s|b|beatmaps|beatmapsets)\/(\d+)\#?(fruits|taiko|mania|osu)?\/?(\d+)?$/gi;
            $("#b-form").submit(function(n) {
                ...
                var r = {};
                "s" == o[1] || "beatmapsets" == o[1] ? r.set_id = +o[2] : r.id = +o[2];
                var a = $(this);
...
i18next.use(i18nextXHRBackend).init({
    ...
    load: "currentOnly",
    backend: {
        loadPath: "https://i.datenshi.xyz/static/locale/{{lng}}.json"
    }
});
